...
export default function Webdev({
  ...
  const videoData = [
    {
      id: 1,
      url: "https://www.youtube.com/embed/HfTXHrWMGVY",
      title: "Web Development",
      description: "Foundational concepts and modern workflows",
      xp: 50,
      difficulty: "Beginner"
    },
    {
    ...
    {
      id: 4,
      url: "https://www.youtube.com/embed/M_P7qSiI14U",
      title: "Cross-Browser Compatibility",
      description: "Ensuring consistent experiences across platforms",
      xp: 100,
      difficulty: "Advanced"
    },
    {
      id: 5,
      url: "https://www.youtube.com/embed/Hq5AHD8PKhY",
      title: "Progressive Web Apps (PWAs)",
      description: "Building app-like web experiences",
      xp: 100,
      difficulty: "Advanced"
    },
    {
      id: 6,
      url: "https://www.youtube.com/embed/s7wmiS2mSXY",
      title: "API Integration",
      description: "Connecting services through RESTful interfaces",
      xp: 75,
      difficulty: "Intermediate"
    },
    {
      id: 7,
      url: "https://www.youtube.com/embed/bpWzFFbWxZg",
    ...
    {
      id: 10,
      url: "https://www.youtube.com/embed/-bt_y4Loofg",
      title: "MongoDB",
    ...
    <div className="webdev-page">
      ...
      <div className="tech-header">
        ...
        <p className="subtitle">
          Master web technologies through interactive learning paths and hands-on projects
        </p>
      </div>
      ...
      <div className="mission-status">
        <div className="status-item">
          ...
          <span className="status-label">TOPICS MASTERED</span>
        </div>
        <div className="status-item">
          <span className="status-value">{videoData.length - completedTopics.size}</span>
          <span className="status-label">TOPICS REMAINING</span>
        </div>
        <div className="status-item">
        ...
        <div className="slider">
          <AnimatePresence mode="wait">
            {visibleCards.map((card, index) => (
              <motion.div
                key={card.id}
                className={`web-card ${card.completed ? 'completed' : ''}`}
      ...
      {xp >= 300 && (
        ...
        >
          ...
          <div className="achievement-content">
            ...
            <p>Frontend Developer Badge Earned</p>
          </div>
        </motion.div>
      )}
        ...
        <div className="video-modal" onClick={() => setSelectedVideo(null)}>
          ...
          >
            ...
            <div className="video-meta">
              ...
              >
                MARK TOPIC COMPLETE (+{videoData[selectedVideo].xp} XP)
              </button>
            </div>
          </motion.div>
        </div>
